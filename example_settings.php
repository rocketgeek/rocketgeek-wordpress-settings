<?php
add_filter( 'rgwps_example_register_settings', 'rgwps_example_tabless_settings' );

function rgwps_example_tabless_settings( $rgwps_settings ) {

    $rgwps_settings[] = array(
		'section_id'          => 'general',
	...
	return $rgwps_settings;
}

/**
 * Tabbed example.
 *
 * @param array $rgwps_settings settings.
 */
function rgwps_tabbed_settings( $rgwps_settings ) {

	// Submit button.
	$rgwps_settings['submit'] = array(
	...
	$rgwps_settings['tabs'] = array(
		...
		array(
			'id' => 'list_table',
			'title' => esc_html( 'List Table', 'text-domain' ),
			'list_table' => true,
		),
	);

	// Settings.
	$rgwps_settings['sections'] = array(
		array(
			'tab_id'        => 'tab_1',
			'section_id'    => 'section_1',
			'section_title' => 'Section 1',
			'section_description' => "This is a description of this section's settings.  It's a demo of the settions options.",
			'section_order' => 10,
			'fields'        => array(
				array(
					'id'      => 'text-1',
		...
		array(
			...
			'fields'        => array(
				array(
					...
					'desc'    => 'This is a description. This is a <a href="#tab-tab_2" class="wsf-internal-link">link</a> to a setting in a different tab.',
					'type'    => 'text',
					'default' => 'This is default',
				),
			),
		...
		array(
			'tab_id'        => 'list_table',
			'section_id'    => 'list_section',
			'section_title' => 'List Table',
			'section_order' => 10,
			'list_table' => array(
				'parent_atts' => array(
					'singular'  => '60s hit',
